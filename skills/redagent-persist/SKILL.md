...
# RedAgent Persistence — Keep What You Take
...
1. **Corpus first**: `redagent kb "persistence scheduled task registry cron autorun"` — HackTricks + ired.team have the full playbooks.
2. **Rack selection**: `redagent atomic select persistence --platform <linux|windows>` — pick 4-6 tests across mechanisms.
3. **Weapons**: `redagent weapons persistence` — PowerUp, Empire, Sliver, macro_pack...
